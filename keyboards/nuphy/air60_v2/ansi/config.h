...
// 0b1110101 AD <-> SCL
// 0b1110110 AD <-> SDA
// Old naming (for backwards compatibility with keymap code)
#define DRIVER_ADDR_1              0b1010000
#define DRIVER_ADDR_2              0b1010011
#define ISSI_TIMEOUT               1

// New IS31FL3733 driver configuration
#define IS31FL3733_I2C_ADDRESS_1   0x50  // GND_GND
#define IS31FL3733_I2C_ADDRESS_2   0x53  // GND_VCC
